...
**Plans:** 2 plans
Plans:
- [ ] 08-01-PLAN.md — Convert absolute paths to relative for GitHub Pages subdirectory hosting
- [ ] 08-02-PLAN.md — Deploy to GitHub Pages, create install guide, verify on iPads
...
| 8. Deploy and Install | v1.1 | 0/2 | Not started | - |
